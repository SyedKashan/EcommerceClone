                ...
                <div class="wrap-slick2">
                    <div class="slick2">
                        ...
                        <div class="item-slick2 p-l-15 p-r-15">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
                                    <img src="{{asset('svg/frontendImages/item-02.jpg')}}" alt="IMG-PRODUCT">
                        ...
                        <div class="item-slick2 p-l-15 p-r-15">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                    <img src="{{asset('svg/frontendImages/item-03.jpg')}}" alt="IMG-PRODUCT">
                        ...
                        <div class="item-slick2 p-l-15 p-r-15">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative">
                                    <img src="{{asset('svg/frontendImages/item-05.jpg')}}" alt="IMG-PRODUCT">
                        ...
                        <div class="item-slick2 p-l-15 p-r-15">
                            ...
                            <div class="block2">
                                <div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelsale">
                                    <img src="{{asset('svg/frontendImages/item-07.jpg')}}" alt="IMG-PRODUCT">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 col-md-8 col-lg-6 m-l-r-auto p-t-15 p-b-15">
                        <div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
                            <img src="{{asset('svg/frontendImages/shop-item-09.jpg')}}" alt="IMG-BANNER">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                        ...
                        <div class="block3">
                            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
                                <img src="{{asset('svg/frontendImages/blog-01.jpg')}}" alt="IMG-BLOG">
                            </a>
                    ...
                    <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                        ...
                        <div class="block3">
                            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
                                <img src="{{asset('svg/frontendImages/blog-02.jpg')}}" alt="IMG-BLOG">
                            </a>
                    ...
                    <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                        ...
                        <div class="block3">
                            <a href="blog-detail.html" class="block3-img dis-block hov-img-zoom">
                                <img src="{{asset('svg/frontendImages/blog-03.jpg')}}" alt="IMG-BLOG">
                            </a>
        ...
        <section class="instagram p-t-20">
            ...
            <div class="flex-w">
                ...
                <div class="block4 wrap-pic-w">
                    <img src="{{asset('svg/frontendImages/gallery-03.jpg')}}" alt="IMG-INSTAGRAM">
                ...
                <!-- Block4 -->
                <div class="block4 wrap-pic-w">
                    <img src="{{asset('svg/frontendImages/gallery-07.jpg')}}" alt="IMG-INSTAGRAM">
                ...
                <!-- Block4 -->
                <div class="block4 wrap-pic-w">
                    <img src="{{asset('svg/frontendImages/gallery-09.jpg')}}" alt="IMG-INSTAGRAM">
                ...
                <!-- Block4 -->
                <div class="block4 wrap-pic-w">
                    <img src="{{asset('svg/frontendImages/gallery-13.jpg')}}" alt="IMG-INSTAGRAM">
                ...
                <!-- Block4 -->
                <div class="block4 wrap-pic-w">
                    <img src="{{asset('svg/frontendImages/gallery-15.jpg')}}" alt="IMG-INSTAGRAM">
